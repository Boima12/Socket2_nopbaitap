...
public class Handler implements Runnable {
	...
	public Handler(Socket clientValue1) {
		try {
			...
			System.out.println(Handler_ClientName + " has connected successfully!");
	...
	public void closeEverything(Socket sk1, DataInputStream datain, DataOutputStream dataout, BufferedReader bfread, BufferedWriter bfwrite) {
		...
		System.out.println(Handler_ClientName + " has disconnected successfully!, Currently online: " + Handler_Clients.size());
